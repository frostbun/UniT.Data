...
namespace UniT.Data.Storage
{
    ...
    public class PlayerPrefsTextDataStorage : WritableDataStorage<string>
    {
        [Preserve]
        public PlayerPrefsTextDataStorage()
        {
        }

        public sealed override string? Read(string key) => PlayerPrefs.GetString(key).NullIfWhiteSpace();

        public sealed override void Write(string key, string value) => PlayerPrefs.SetString(key, value);
