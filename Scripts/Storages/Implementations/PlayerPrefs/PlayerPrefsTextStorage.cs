...
namespace UniT.Data.Storages
{
    ...
    public class PlayerPrefsTextStorage : IFlushableStorage
    {
        [Preserve]
        ...
        object IStorage.Read(string key) => PlayerPrefs.GetString(key);

        void IWritableStorage.Write(string key, object value) => PlayerPrefs.SetString(key, (string)value);
        ...
        {
            callback(PlayerPrefs.GetString(key));
            yield break;
        }
